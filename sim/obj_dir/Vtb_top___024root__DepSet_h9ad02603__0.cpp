...
#endif
            VL_FATAL_MT("tb_top.sv", 7, "", "Input combinational region did not converge.");
        }
...
#endif
            VL_FATAL_MT("tb_top.sv", 7, "", "NBA region did not converge.");
        }
...
#endif
                VL_FATAL_MT("tb_top.sv", 7, "", "Active region did not converge.");
            }
