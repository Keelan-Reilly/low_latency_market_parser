...
void Vtb_top___024root__trace_chg_0_sub_0(Vtb_top___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgCData(oldp+9,(vlSelf->tb_top__DOT__u_prg__DOT__l2t_type_reg),8);
        bufp->chgBit(oldp+10,(vlSelf->tb_top__DOT__u_prg__DOT__l2t_data_valid));
        bufp->chgCData(oldp+11,(vlSelf->tb_top__DOT__u_eth__DOT__state),3);
        bufp->chgCData(oldp+12,(vlSelf->tb_top__DOT__u_eth__DOT__pre_cnt),3);
        bufp->chgCData(oldp+13,(vlSelf->tb_top__DOT__u_eth__DOT__crc_cnt),4);
        bufp->chgSData(oldp+14,(vlSelf->tb_top__DOT__u_eth__DOT__hdr_cnt),16);
        bufp->chgSData(oldp+15,(vlSelf->tb_top__DOT__u_eth__DOT__payload_cnt),16);
        bufp->chgSData(oldp+16,(vlSelf->tb_top__DOT__u_eth__DOT__payload_len),16);
        bufp->chgQData(oldp+17,(vlSelf->tb_top__DOT__u_eth__DOT__dest_mac_shift),48);
        bufp->chgBit(oldp+19,(vlSelf->tb_top__DOT__u_eth__DOT__mac_match));
        bufp->chgIData(oldp+20,(vlSelf->tb_top__DOT__u_eth__DOT__crc_reg),32);
        bufp->chgIData(oldp+21,(vlSelf->tb_top__DOT__u_eth__DOT__crc_recv_shift),32);
        bufp->chgBit(oldp+22,(vlSelf->tb_top__DOT__u_eth__DOT__this_cycle_match));
        bufp->chgIData(oldp+23,(vlSelf->tb_top__DOT__u_eth__DOT__next_crc),32);
        ...
        bufp->chgCData(oldp+33,(vlSelf->tb_top__DOT__u_pr__DOT__len_lo),8);
        bufp->chgCData(oldp+34,(vlSelf->tb_top__DOT__u_pr__DOT__type_reg),8);
        bufp->chgSData(oldp+35,(vlSelf->tb_top__DOT__u_pr__DOT__cnt),16);
        bufp->chgSData(oldp+36,(vlSelf->tb_top__DOT__u_pr__DOT__body_left),16);
        bufp->chgCData(oldp+37,(vlSelf->tb_top__DOT__u_prg__DOT__p2l_type_reg),8);
        bufp->chgIData(oldp+38,(vlSelf->tb_top__DOT__u_prg__DOT__p2l_price_reg),32);
        bufp->chgIData(oldp+39,(vlSelf->tb_top__DOT__u_prg__DOT__p2l_volume_reg),32);
        bufp->chgBit(oldp+40,(vlSelf->tb_top__DOT__u_prg__DOT__p2l_data_valid));
        bufp->chgIData(oldp+41,(vlSelf->tb_top__DOT__u_prg__DOT__ingress_last),32);
        bufp->chgIData(oldp+42,(vlSelf->tb_top__DOT__u_prg__DOT__ingress_s2),32);
        bufp->chgIData(oldp+43,(vlSelf->tb_top__DOT__u_prg__DOT__p2l_timestamp),32);
        bufp->chgIData(oldp+44,(vlSelf->tb_top__DOT__u_prg__DOT__l2t_data_reg),32);
        bufp->chgIData(oldp+45,(vlSelf->tb_top__DOT__u_prg__DOT__t_ingress_cap),32);
        bufp->chgIData(oldp+46,(vlSelf->tb_top__DOT__u_prg__DOT__t_parser_cap),32);
        bufp->chgIData(oldp+47,(vlSelf->tb_top__DOT__u_prg__DOT__t_logic_cap),32);
        ...
        bufp->chgCData(oldp+56,(vlSelf->tb_top__DOT__u_ut__DOT__bit_idx),3);
        bufp->chgCData(oldp+57,(vlSelf->tb_top__DOT__u_ut__DOT__sh),8);
        bufp->chgBit(oldp+58,(((0U == (IData)(vlSelf->tb_top__DOT__u_ut__DOT__st)) 
                               & (IData)(vlSelf->tb_top__DOT__u_prg__DOT__l2t_data_valid))));
    }
    bufp->chgBit(oldp+59,(vlSelf->clk));
    bufp->chgBit(oldp+60,(vlSelf->rst_n));
    bufp->chgCData(oldp+61,(vlSelf->rx_byte),8);
    bufp->chgBit(oldp+62,(vlSelf->rx_valid));
    bufp->chgBit(oldp+63,(vlSelf->sink_allow));
    ...
    bufp->chgBit(oldp+93,(vlSelf->l2t_stall));
    bufp->chgIData(oldp+94,(vlSelf->l2t_stall_cycles),32);
    bufp->chgBit(oldp+95,(vlSelf->tb_top__DOT__uart_ready_masked));
    bufp->chgBit(oldp+96,((1U & ((~ (IData)(vlSelf->tb_top__DOT__u_prg__DOT__l2t_data_valid)) 
